...
type Service struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Inventory     *Service_Inventory     `protobuf:"bytes,1,opt,name=inventory,proto3" json:"inventory,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x0fconf/conf.proto\x12\tgoods.api\x1a\x1egoogle/protobuf/duration.proto\"\xd0\x01\n" +
	"\tBootstrap\x12)\n" +
	"\x06server\x18\x01 \x01(\v2\x11.goods.api.ServerR\x06server\x12#\n" +
	"\x04data\x18\x02 \x01(\v2\x0f.goods.api.DataR\x04data\x12&\n" +
	"\x05trace\x18\x03 \x01(\v2\x10.goods.api.TraceR\x05trace\x12\x1d\n" +
	"\x02mq\x18\x04 \x01(\v2\r.goods.api.MqR\x02mq\x12,\n" +
	"\aservice\x18\x05 \x01(\v2\x12.goods.api.ServiceR\aservice\"\xb6\x02\n" +
	"\x06Server\x12*\n" +
	...
	"\aService\x12:\n" +
	"\tinventory\x18\x01 \x01(\v2\x1c.goods.api.Service.InventoryR\tinventory\x1a'\n" +
	"\tInventory\x12\x1a\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Mq)(nil),                  // 5: goods.api.Mq
	(*Service)(nil),             // 6: goods.api.Service
	(*Server_HTTP)(nil),         // 7: goods.api.Server.HTTP
	(*Server_GRPC)(nil),         // 8: goods.api.Server.GRPC
	(*Data_Database)(nil),       // 9: goods.api.Data.Database
	(*Data_Redis)(nil),          // 10: goods.api.Data.Redis
	(*Data_Elastic)(nil),        // 11: goods.api.Data.Elastic
	(*Registry_Consul)(nil),     // 12: goods.api.Registry.Consul
	(*Service_Inventory)(nil),   // 13: goods.api.Service.Inventory
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 3: goods.api.Bootstrap.mq:type_name -> goods.api.Mq
	6,  // 4: goods.api.Bootstrap.service:type_name -> goods.api.Service
	7,  // 5: goods.api.Server.http:type_name -> goods.api.Server.HTTP
	8,  // 6: goods.api.Server.grpc:type_name -> goods.api.Server.GRPC
	9,  // 7: goods.api.Data.database:type_name -> goods.api.Data.Database
	10, // 8: goods.api.Data.redis:type_name -> goods.api.Data.Redis
	11, // 9: goods.api.Data.elastic:type_name -> goods.api.Data.Elastic
	12, // 10: goods.api.Registry.consul:type_name -> goods.api.Registry.Consul
	13, // 11: goods.api.Service.inventory:type_name -> goods.api.Service.Inventory
	14, // 12: goods.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	14, // 13: goods.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	14, // 14: goods.api.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	14, // 15: goods.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	14, // 16: goods.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
