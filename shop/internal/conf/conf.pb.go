...
type Service struct {
	...
	Payment       *Service_Payment       `protobuf:"bytes,5,opt,name=payment,proto3" json:"payment,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Service) GetPayment() *Service_Payment {
	if x != nil {
		return x.Payment
	}
	return nil
...
func (x *Service_Payment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Service_Payment) ProtoMessage() {}

func (x *Service_Payment) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Service_Payment.ProtoReflect.Descriptor instead.
func (*Service_Payment) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 4}
}

func (x *Service_Payment) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x18internal/conf/conf.proto\x12\bshop.api\x1a\x1egoogle/protobuf/duration.proto\"\xd1\x01\n" +
	"\tBootstrap\x12(\n" +
	...
	"\x05goods\x18\x02 \x01(\v2\x17.shop.api.Service.GoodsR\x05goods\x12*\n" +
	"\x04cart\x18\x03 \x01(\v2\x16.shop.api.Service.CartR\x04cart\x12-\n" +
	"\x05order\x18\x04 \x01(\v2\x17.shop.api.Service.OrderR\x05order\x123\n" +
	"\apayment\x18\x05 \x01(\v2\x19.shop.api.Service.PaymentR\apayment\x1a\"\n" +
	"\x04User\x12\x1a\n" +
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Service_Cart)(nil),        // 13: shop.api.Service.Cart
	(*Service_Order)(nil),       // 14: shop.api.Service.Order
	(*Service_Payment)(nil),     // 15: shop.api.Service.Payment
	(*Registry_Consul)(nil),     // 16: shop.api.Registry.Consul
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	13, // 11: shop.api.Service.cart:type_name -> shop.api.Service.Cart
	14, // 12: shop.api.Service.order:type_name -> shop.api.Service.Order
	15, // 13: shop.api.Service.payment:type_name -> shop.api.Service.Payment
	16, // 14: shop.api.Registry.consul:type_name -> shop.api.Registry.Consul
	17, // 15: shop.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	17, // 16: shop.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	17, // 17: shop.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	17, // 18: shop.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
