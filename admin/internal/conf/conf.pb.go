...
type Service struct {
	...
	Order         *Service_Order         `protobuf:"bytes,3,opt,name=order,proto3" json:"order,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x18internal/conf/conf.proto\x12\tadmin.api\x1a\x1egoogle/protobuf/duration.proto\"\xd6\x01\n" +
	"\tBootstrap\x12)\n" +
	"\x06server\x18\x01 \x01(\v2\x11.admin.api.ServerR\x06server\x12#\n" +
	"\x04data\x18\x02 \x01(\v2\x0f.admin.api.DataR\x04data\x12&\n" +
	"\x05trace\x18\x03 \x01(\v2\x10.admin.api.TraceR\x05trace\x12#\n" +
	"\x04auth\x18\x04 \x01(\v2\x0f.admin.api.AuthR\x04auth\x12,\n" +
	"\aservice\x18\x05 \x01(\v2\x12.admin.api.ServiceR\aservice\"\x9f\x01\n" +
	"\x06Server\x12*\n" +
	"\x04http\x18\x01 \x01(\v2\x16.admin.api.Server.HTTPR\x04http\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xdb\x02\n" +
	"\x04Data\x124\n" +
	"\bdatabase\x18\x01 \x01(\v2\x18.admin.api.Data.DatabaseR\bdatabase\x12+\n" +
	"\x05redis\x18\x02 \x01(\v2\x15.admin.api.Data.RedisR\x05redis\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x84\x02\n" +
	"\aService\x12+\n" +
	"\x04user\x18\x01 \x01(\v2\x17.admin.api.Service.UserR\x04user\x12.\n" +
	"\x05goods\x18\x02 \x01(\v2\x18.admin.api.Service.GoodsR\x05goods\x12.\n" +
	"\x05order\x18\x03 \x01(\v2\x18.admin.api.Service.OrderR\x05order\x1a\"\n" +
	"\x04User\x12\x1a\n" +
	...
	"\x05Trace\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\"z\n" +
	"\bRegistry\x122\n" +
	"\x06consul\x18\x01 \x01(\v2\x1a.admin.api.Registry.ConsulR\x06consul\x1a:\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x16\n" +
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\"\x1f\n" +
	"\x04Auth\x12\x17\n" +
	"\ajwt_key\x18\x01 \x01(\tR\x06jwtKeyB\x1aZ\x18admin/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Service_Order)(nil),       // 12: admin.api.Service.Order
	(*Registry_Consul)(nil),     // 13: admin.api.Registry.Consul
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	12, // 10: admin.api.Service.order:type_name -> admin.api.Service.Order
	13, // 11: admin.api.Registry.consul:type_name -> admin.api.Registry.Consul
	14, // 12: admin.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	14, // 13: admin.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	14, // 14: admin.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
