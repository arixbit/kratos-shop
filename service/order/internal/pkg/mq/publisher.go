...
func (p *Publisher) ensure() error {
	...
	if err := ch.ExchangeDeclare("order.exchange", "topic", true, false, false, false, nil); err != nil {
		_ = ch.Close()
		_ = conn.Close()
		return err
	}
	if err := ch.ExchangeDeclare("inventory.exchange", "topic", true, false, false, false, nil); err != nil {
		_ = ch.Close()
		_ = conn.Close()
		return err
	}
