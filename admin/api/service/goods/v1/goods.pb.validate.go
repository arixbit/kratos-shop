...
func (m *SkuInfo) validate(all bool) error {
	...
	// no validation rules for AttrInfo
...
func (m *SkuListResponse) validate(all bool) error {
	...
	for idx, item := range m.GetList() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SkuListResponseValidationError{
						field:  fmt.Sprintf("List[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return SkuListResponseValidationError{
					field:  fmt.Sprintf("List[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
...
// Validate checks the field values on UpdateGoodsInfoRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateGoodsInfoRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateGoodsInfoRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateGoodsInfoRequestMultiError, or nil if none found.
func (m *UpdateGoodsInfoRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateGoodsInfoRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateGoodsInfoRequestMultiError(errors)
	}

	return nil
}

// UpdateGoodsInfoRequestMultiError is an error wrapping multiple validation
// errors returned by UpdateGoodsInfoRequest.ValidateAll() if the designated
// constraints aren't met.
type UpdateGoodsInfoRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateGoodsInfoRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateGoodsInfoRequestMultiError) AllErrors() []error { return m }

// UpdateGoodsInfoRequestValidationError is the validation error returned by
// UpdateGoodsInfoRequest.Validate if the designated constraints aren't met.
type UpdateGoodsInfoRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateGoodsInfoRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateGoodsInfoRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateGoodsInfoRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateGoodsInfoRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateGoodsInfoRequestValidationError) ErrorName() string {
	return "UpdateGoodsInfoRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateGoodsInfoRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateGoodsInfoRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateGoodsInfoRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateGoodsInfoRequestValidationError{}
...
// Validate checks the field values on SkuDetail with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *SkuDetail) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SkuDetail with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in SkuDetailMultiError, or nil
// if none found.
func (m *SkuDetail) ValidateAll() error {
	return m.validate(true)
}

func (m *SkuDetail) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SkuDetailMultiError(errors)
	}

	return nil
}

// SkuDetailMultiError is an error wrapping multiple validation errors returned
// by SkuDetail.ValidateAll() if the designated constraints aren't met.
type SkuDetailMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SkuDetailMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SkuDetailMultiError) AllErrors() []error { return m }

// SkuDetailValidationError is the validation error returned by
// SkuDetail.Validate if the designated constraints aren't met.
type SkuDetailValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SkuDetailValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SkuDetailValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SkuDetailValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SkuDetailValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SkuDetailValidationError) ErrorName() string { return "SkuDetailValidationError" }

// Error satisfies the builtin error interface
func (e SkuDetailValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = SkuDetailValidationError{}
