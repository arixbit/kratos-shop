...
const file_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x0fconf/conf.proto\x12\torder.api\x1a\x1egoogle/protobuf/duration.proto\"\xf5\x01\n" +
	"\tBootstrap\x12)\n" +
	"\x06server\x18\x01 \x01(\v2\x11.order.api.ServerR\x06server\x12#\n" +
	"\x04data\x18\x02 \x01(\v2\x0f.order.api.DataR\x04data\x12&\n" +
	"\x05trace\x18\x03 \x01(\v2\x10.order.api.TraceR\x05trace\x12#\n" +
	"\x04auth\x18\x04 \x01(\v2\x0f.order.api.AuthR\x04auth\x12,\n" +
	"\aservice\x18\x05 \x01(\v2\x12.order.api.ServiceR\aservice\x12\x1d\n" +
	"\x02mq\x18\x06 \x01(\v2\r.order.api.MqR\x02mq\"\xb6\x02\n" +
	"\x06Server\x12*\n" +
	"\x04http\x18\x01 \x01(\v2\x16.order.api.Server.HTTPR\x04http\x12*\n" +
	"\x04grpc\x18\x02 \x01(\v2\x16.order.api.Server.GRPCR\x04grpc\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xc5\x03\n" +
	"\x04Data\x124\n" +
	"\bdatabase\x18\x01 \x01(\v2\x18.order.api.Data.DatabaseR\bdatabase\x12+\n" +
	"\x05redis\x18\x02 \x01(\v2\x15.order.api.Data.RedisR\x05redis\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\a \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x1f\n" +
	"\x04Auth\x12\x17\n" +
	"\ajwt_key\x18\x01 \x01(\tR\x06jwtKey\"z\n" +
	"\bRegistry\x122\n" +
	"\x06consul\x18\x01 \x01(\v2\x1a.order.api.Registry.ConsulR\x06consul\x1a:\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x16\n" +
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\"#\n" +
	"\x05Trace\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\"\x80\x02\n" +
	"\aService\x12+\n" +
	"\x04user\x18\x01 \x01(\v2\x17.order.api.Service.UserR\x04user\x12+\n" +
	"\x04cart\x18\x02 \x01(\v2\x17.order.api.Service.CartR\x04cart\x12.\n" +
	"\x05goods\x18\x03 \x01(\v2\x18.order.api.Service.GoodsR\x05goods\x1a\"\n" +
	"\x04User\x12\x1a\n" +
	...
	"\x02Mq\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addrB\x1cZ\x1aservice/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Mq)(nil),                  // 7: order.api.Mq
	(*Server_HTTP)(nil),         // 8: order.api.Server.HTTP
	(*Server_GRPC)(nil),         // 9: order.api.Server.GRPC
	(*Data_Database)(nil),       // 10: order.api.Data.Database
	(*Data_Redis)(nil),          // 11: order.api.Data.Redis
	(*Registry_Consul)(nil),     // 12: order.api.Registry.Consul
	(*Service_User)(nil),        // 13: order.api.Service.User
	(*Service_Cart)(nil),        // 14: order.api.Service.Cart
	(*Service_Goods)(nil),       // 15: order.api.Service.Goods
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 5: order.api.Bootstrap.mq:type_name -> order.api.Mq
	8,  // 6: order.api.Server.http:type_name -> order.api.Server.HTTP
	9,  // 7: order.api.Server.grpc:type_name -> order.api.Server.GRPC
	10, // 8: order.api.Data.database:type_name -> order.api.Data.Database
	11, // 9: order.api.Data.redis:type_name -> order.api.Data.Redis
	12, // 10: order.api.Registry.consul:type_name -> order.api.Registry.Consul
	13, // 11: order.api.Service.user:type_name -> order.api.Service.User
	14, // 12: order.api.Service.cart:type_name -> order.api.Service.Cart
	15, // 13: order.api.Service.goods:type_name -> order.api.Service.Goods
	16, // 14: order.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	16, // 15: order.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	16, // 16: order.api.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	16, // 17: order.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	16, // 18: order.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
